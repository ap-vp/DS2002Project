...
3. **NoSQL source (MongoDB)**:
   - attempted to load provider reference data to build `dim_provider` (Mongo connectivity errors depending on cluster/network setup, but the notebook includes the integration step).
